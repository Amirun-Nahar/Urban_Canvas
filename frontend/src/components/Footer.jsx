    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {/* Company Info */}
          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">Urban Canvas</h3>
            <p className="mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:info@urbancanvas.com" className="hover:text-white">
                  Email: info@urbancanvas.com
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="w-full rounded-l-md border-0 bg-gray-800 px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <button
                type="submit"
